...
import com.pms.projectmanagementsystem.model.Project;
import com.pms.projectmanagementsystem.model.User;
import com.pms.projectmanagementsystem.repository.InviteRequest;
import com.pms.projectmanagementsystem.response.MessageResponse;
import com.pms.projectmanagementsystem.service.InvitationService;
...
public class ProjectController {
    ...
    public ResponseEntity<MessageResponse> inviteProject(
        ...
        System.out.println("Invite request received: " + inviteRequest); // Add logging
        User user = userService.findUserProfileByJwt(jwt);
